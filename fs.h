 ...
 *
 * change SUPER_BLOCK_SIZE if the members are changed.
 */
struct super_block {
 ...
 * hange INODE_SIZE if the members are changed
 */
struct inode {
...
/**
 * Since all invocations of `rw_sector()' in FS look similar  we use this macro to make code more readable.
 */
